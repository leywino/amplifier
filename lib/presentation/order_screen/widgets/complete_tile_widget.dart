...
class CompletedTileWidget extends StatefulWidget {
  ...
  @override
  State<CompletedTileWidget> createState() => _CompletedTileWidgetState();
}

class _CompletedTileWidgetState extends State<CompletedTileWidget> {
